      ...
      {cardItems.length === 0 ? (
        ...
        <div className="space-y-4">
          {cardItems.map((item, index) => (
            <div
              key={index}
              className="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow"
            >
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex gap-4 items-center flex-1">
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-lg mb-1">{item.title?.[lang]}</h3>
                ...
                <div className="hidden md:flex items-center gap-4">
                  ...
                  <div className="text-right">
                    <div className="text-xl font-bold">{item.price * item.count}₽</div>
                  </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 mt-6">
            <div className="flex justify-between items-center text-2xl font-bold text-gray-800 dark:text-gray-100">
              <span>
                {lang === 'ru' ? 'Итого:' :
                 lang === 'uz' ? 'Jami:' :
                 'Total:'}
